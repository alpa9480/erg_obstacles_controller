...
public:
    ...
    void setupUi(QWidget *MotionPlanningFrameJointsUI)
    {
        ...
        nullspace_label->setObjectName(QStringLiteral("nullspace_label"));
        ...
        dummy_ns_slider_->setObjectName(QStringLiteral("dummy_ns_slider_"));
...
"\n"
"Each basis vector of the (linear) nullspace is represented by a separate slider.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        nullspace_label->setText(QApplication::translate("MotionPlanningFrameJointsUI", "Nullspace exploration:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
"That's typically the case for redundant robots, i.e. 7+ joints, or singular configurations.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
