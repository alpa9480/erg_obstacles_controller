...
"This is usually achieved by random seeding, which can flip the robot configuration (e.g. elbow up/down). Note that motion planning is always collision-aware, regardless of this checkbox.", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        shape_size_y_spin_box->setToolTip(QApplication::translate("MotionPlanningUI", "y dimension", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        shape_size_z_spin_box->setToolTip(QApplication::translate("MotionPlanningUI", "z dimension", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        export_scene_geometry_text_button->setToolTip(QApplication::translate("MotionPlanningUI", "Export scene geometry to a .scene file (only world object information is preserved)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        export_scene_geometry_text_button->setText(QApplication::translate("MotionPlanningUI", "&Export", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        import_scene_geometry_text_button->setToolTip(QApplication::translate("MotionPlanningUI", "Import scene geometry from a .scene file (only world object information is preserved)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        tabWidget->setTabText(tabWidget->indexOf(status), QApplication::translate("MotionPlanningUI", "Status", Q_NULLPTR));
