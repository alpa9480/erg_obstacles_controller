...
"""autogenerated by genpy from franka_example_controllers/TrajectoryPredictions.msg. Do not edit."""
import codecs
import sys
...
class TrajectoryPredictions(genpy.Message):
  _md5sum = "b4a2dfd99353bbeaa2f744dbc96c3ba8"
  _type = "franka_example_controllers/TrajectoryPredictions"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float64 time_pred
float64 duration_pred
float64[700] q_pred
float64[700] dotq_pred
float64[700] tau_pred"""
  __slots__ = ['time_pred','duration_pred','q_pred','dotq_pred','tau_pred']
  _slot_types = ['float64','float64','float64[700]','float64[700]','float64[700]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       time_pred,duration_pred,q_pred,dotq_pred,tau_pred
    ...
    if args or kwds:
      ...
      if self.time_pred is None:
        self.time_pred = 0.
      if self.duration_pred is None:
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2d().pack(_x.time_pred, _x.duration_pred))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time_pred, _x.duration_pred,) = _get_struct_2d().unpack(str[start:end])
      start = end
      end += 5600
